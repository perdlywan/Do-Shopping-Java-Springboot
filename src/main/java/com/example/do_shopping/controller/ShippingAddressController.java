...
public class ShippingAddressController {
        ...
        public ResponseEntity<PagedResponseDTO<ShippingAddressResponseDTO>> getMyAddress(
                ...
                Page<ShippingAddress> shippingAddressPage = shippingAddressService.getMyShippingAddresses(pageIndex,
        ...
        @PostMapping
        public ResponseEntity<ActionSuccessResponseDTO> addAdress(
                        @Valid @RequestBody AddShippingAddressRequestDTO request) {
                ShippingAddress shippingAddress = shippingAddressService.addAddress(request);

                ShippingAddressResponseDTO shippingAddressResponseDTO = mapToResponseDTO(shippingAddress);
        ...
        @PutMapping("/{id}")
        public ResponseEntity<ActionSuccessResponseDTO> updateAddress(@PathVariable("id") String id,
        ...
        private ShippingAddressResponseDTO mapToResponseDTO(ShippingAddress shippingAddress) {
